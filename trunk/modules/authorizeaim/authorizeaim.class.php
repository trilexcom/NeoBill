...
class AuthorizeAIM extends PaymentGatewayModule
{
   ...
   */
  function getAPIVersion() { return $this->APIVersion; }
   ...
   */
  function getDelimiter() { return $this->delimiter; }
   ...
   */
  function getLoginID() { return $this->loginID; }
   ...
   */
  function getTransactionKey() { return $this->transactionKey; }
   ...
   */
  function setDelimiter( $char ) { $this->delimiter = $char; }
   ...
   */
  function setLoginID( $loginID ) { $this->loginID = $loginID; }
   ...
   */
  function setTransactionKey( $key ) { $this->transactionKey = $key; }
