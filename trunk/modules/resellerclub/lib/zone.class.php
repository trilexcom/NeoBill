<?php
	...
	*/
	...
	/**
	* This class consist of functions related to Managed DNS Service.
	*/
	class Zone
	{
		/**
		...
		*
		*/
		function Zone($wsdlurl="wsdl/Zone.wsdl")
		{
			$this->wsdl = $wsdlurl;
		...
		*/
		 ...
		 * @param recordtype String value indicating the recordtype
		 * Valid values are : A,CNAME,MX,NS  Pass null to ignore this criteria
		 *
		 * @param source
		 *
		 * @param destination
		 ...
		 *
  		 * <br><br><b>Returns:</b>
		 *  <br>An AssociativeArray which contains list of orders matching the search criteria
		 *	<br>The Keys for the HashMap are values from 1 to n. The Value is another HashMap
	    ...
	    function listOrder($userName, $password, $role, $langpref, $parentid,
                          ...
                          $currentStatus, $description, $recordtype, $source, $destination,
                          $creationDTRangStart, $creationDTRangEnd, $endTimeRangStart,
                          $endTimeRangEnd, $numOfRecordPerPage, $pageNum, $orderBy)
		{
		 ...
		 * <br><br><b>Returns:</b>
		 * An Associative Array with the result of the Addition. The HashMap has the
		...
		*
		* <br><br><b>Returns:</b>
		*   An Associative Array with the result of the Renwwal. The HashMap has the
		*	domainnames as the key, and a HashMap as the value. The inner HashMap will have key-values
		*	as follows:
		*	<pre>
		*	entityid=435
		...
		*/		
		...
		/**
		 * Attempts to delete the Managed DNS Service for the specified domain
		 *
		 * @return AssociativeArray	
		 *
		 * @param entityId The entityId under which the service is to be deleted
		 * <br><br><b>Returns:</b>
		 * An Associative Array with the result of the deletion.
		 */		
