<ul id="tabnav">
  ...
  <li class="selected"> <a href="manager_content.php?page=settings&action=locale"> [LOCALE] </a> </li>
  <li> <a href="manager_content.php?page=settings&action=payment_gateway"> [PAYMENTS] </a> </li> </li>
</ul>
