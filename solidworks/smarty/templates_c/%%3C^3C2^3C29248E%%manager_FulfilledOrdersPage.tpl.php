<?php /* Smarty version 2.6.14, created on 2007-08-24 11:58:34
         compiled from manager_FulfilledOrdersPage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'echo', 'manager_FulfilledOrdersPage.tpl', 1, false),array('function', 'dbo_echo', 'manager_FulfilledOrdersPage.tpl', 11, false),array('block', 'dbo_table', 'manager_FulfilledOrdersPage.tpl', 4, false),array('block', 'dbo_table_column', 'manager_FulfilledOrdersPage.tpl', 10, false),array('modifier', 'datetime', 'manager_FulfilledOrdersPage.tpl', 25, false),array('modifier', 'currency', 'manager_FulfilledOrdersPage.tpl', 37, false),)), $this); ?>
<h2><?php echo smarty_echo(array('phrase' => 'FULFILLED_ORDERS'), $this);?>
</h2>

<div class="table">
  <?php $this->_tag_stack[] = array('dbo_table', array('dbo_class' => 'OrderDBO','name' => 'orderdbo_table','filter' => "status='Fulfilled'",'title' => "[PENDING_ORDERS]",'size' => '10')); $_block_repeat=true;smarty_dbo_table($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
"><?php echo smarty_dbo_echo(array('dbo' => 'orderdbo_table','field' => 'id'), $this);?>
    ...
    <?php $this->_tag_stack[] = array('dbo_table_column', array('header' => "[ACCOUNT]")); $_block_repeat=true;smarty_dbo_table_column($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
      <a href="manager_content.php?page=accounts_view_account&id=<?php echo smarty_dbo_echo(array('dbo' => 'orderdbo_table','field' => 'accountid'), $this);?>
"><?php echo smarty_dbo_echo(array('dbo' => 'orderdbo_table','field' => 'accountname'), $this);?>
</a>
      <br/>
    ...
    <?php $this->_tag_stack[] = array('dbo_table_column', array('header' => "[DATE_FULFILLED]")); $_block_repeat=true;smarty_dbo_table_column($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
      <?php echo ((is_array($_tmp=smarty_dbo_echo(array('dbo' => 'orderdbo_table','field' => 'datefulfilled'), $this))) ? $this->_run_mod_handler('datetime', true, $_tmp) : smarty_modifier_datetime($_tmp));?>
