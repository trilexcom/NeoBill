<?php /* Smarty version 2.6.14, created on 2007-08-24 11:58:30
         compiled from manager_InactiveAccounts.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'echo', 'manager_InactiveAccounts.tpl', 2, false),array('function', 'form_element', 'manager_InactiveAccounts.tpl', 4, false),array('function', 'form_description', 'manager_InactiveAccounts.tpl', 15, false),array('function', 'dbo_echo', 'manager_InactiveAccounts.tpl', 42, false),array('block', 'form', 'manager_InactiveAccounts.tpl', 3, false),array('block', 'dbo_table', 'manager_InactiveAccounts.tpl', 35, false),array('block', 'dbo_table_column', 'manager_InactiveAccounts.tpl', 41, false),array('modifier', 'currency', 'manager_InactiveAccounts.tpl', 50, false),)), $this); ?>
<div class="action">
...
<h2> <?php echo smarty_echo(array('phrase' => 'INACTIVE_ACCOUNTS'), $this);?>
 </h2>
<div class="search">
  <?php $this->_tag_stack[] = array('form', array('name' => 'search_inactive_accountdbo_table')); $_block_repeat=true;smarty_form($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <table>
      <tr>
...
<div class="table">
  <?php $this->_tag_stack[] = array('dbo_table', array('dbo_class' => 'AccountDBO','name' => 'inactive_accountdbo_table','filter' => "status='Inactive'",'title' => "[ACCOUNTS]",'size' => '10')); $_block_repeat=true;smarty_dbo_table($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    ...
    <?php $this->_tag_stack[] = array('dbo_table_column', array('header' => "[ID]",'sort_field' => 'id')); $_block_repeat=true;smarty_dbo_table_column($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
      <a target="content" href="manager_content.php?page=accounts_view_account&id=<?php echo smarty_dbo_echo(array('dbo' => 'inactive_accountdbo_table','field' => 'id'), $this);?>
"><?php echo smarty_dbo_echo(array('dbo' => 'inactive_accountdbo_table','field' => 'id'), $this);?>
</a>
    ...
    <?php $this->_tag_stack[] = array('dbo_table_column', array('header' => "[ACCOUNT_NAME]")); $_block_repeat=true;smarty_dbo_table_column($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
      <a target="content" href="manager_content.php?page=accounts_view_account&id=<?php echo smarty_dbo_echo(array('dbo' => 'inactive_accountdbo_table','field' => 'id'), $this);?>
"><?php echo smarty_dbo_echo(array('dbo' => 'inactive_accountdbo_table','field' => 'accountname'), $this);?>
</a>
    <?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_dbo_table_column($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
    ...
    <?php $this->_tag_stack[] = array('dbo_table_column', array('header' => "[BALANCE]")); $_block_repeat=true;smarty_dbo_table_column($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
      <?php echo ((is_array($_tmp=smarty_dbo_echo(array('dbo' => 'inactive_accountdbo_table','field' => 'balance'), $this))) ? $this->_run_mod_handler('currency', true, $_tmp) : smarty_modifier_currency($_tmp));?>
    ...
    <?php $this->_tag_stack[] = array('dbo_table_column', array('header' => "[STATUS]",'sort_field' => 'status')); $_block_repeat=true;smarty_dbo_table_column($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
      <?php echo smarty_dbo_echo(array('dbo' => 'inactive_accountdbo_table','field' => 'status'), $this);?>
