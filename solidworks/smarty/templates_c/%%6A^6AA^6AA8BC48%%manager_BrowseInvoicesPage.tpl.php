<?php /* Smarty version 2.6.14, created on 2007-08-24 11:58:37
         compiled from manager_BrowseInvoicesPage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'form', 'manager_BrowseInvoicesPage.tpl', 3, false),array('block', 'dbo_table', 'manager_BrowseInvoicesPage.tpl', 32, false),array('block', 'dbo_table_column', 'manager_BrowseInvoicesPage.tpl', 37, false),array('function', 'form_element', 'manager_BrowseInvoicesPage.tpl', 4, false),array('function', 'echo', 'manager_BrowseInvoicesPage.tpl', 8, false),array('function', 'form_description', 'manager_BrowseInvoicesPage.tpl', 16, false),array('function', 'dbo_echo', 'manager_BrowseInvoicesPage.tpl', 38, false),array('modifier', 'datetime', 'manager_BrowseInvoicesPage.tpl', 46, false),array('modifier', 'currency', 'manager_BrowseInvoicesPage.tpl', 55, false),)), $this); ?>
<div class="action">
...
<div class="search">
  <?php $this->_tag_stack[] = array('form', array('name' => 'search_invoicedbo_table')); $_block_repeat=true;smarty_form($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <table>
      <tr>
...
<div class="table">
  <?php $this->_tag_stack[] = array('dbo_table', array('dbo_class' => 'InvoiceDBO','name' => 'invoicedbo_table','title' => "[INVOICES]",'size' => '10')); $_block_repeat=true;smarty_dbo_table($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
