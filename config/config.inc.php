...
$config['installed']	= 0;
$config['cache'] = '/var/webs/dev.stalag13.net/htdocs/solidstate-0.4/solidworks/smarty/cache';
$config['compiled'] = '/var/webs/dev.stalag13.net/htdocs/solidstate-0.4/solidworks/smarty/templates_c';
$config['encoded']	= 1;
