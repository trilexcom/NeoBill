...
<table border=0 cellpadding="0" cellspacing="0" width=100%>
  <tr>
    ...
    <td width=60% align=center>
      <a href="http://scbr.com/docs/company.shtml" border=0 onFocus="blur();">
      <img src="http://scbr.com/img/globe1.gif" border=0 width=369 height=368>
      </a>
    </td>
    <td width=20%></td>
  </tr>
...
Scand LLC is a software development company based in Eastern Europe (Minsk, Belarus).
</p>
<p>
We are 90 IT engineers specializing in software development: J2EE, .NET, C++, PHP and other.</a>
</p>
<p>
