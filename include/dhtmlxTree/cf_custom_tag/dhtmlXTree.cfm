...
<cfif ThisTag.ExecutionMode is "End">
	<cfsavecontent variable="treeOutput">
		...
		<cfif not isDefined("request.dhtmlXTreeScriptsInserted")>
			...
			<script type="text/javascript" src="#attributes.JSPath#dhtmlXCommon.js" type="text/javascript"></script>
			<script type="text/javascript" src="#attributes.JSPath#dhtmlXTree.js" type="text/javascript"></script>
