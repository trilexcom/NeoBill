...
dhtmlXTreeObject.prototype._attachChildNode=function(parentObject,itemId,itemText,itemActionHandler,image1,image2,image3,optionStr,childs,beforeNode) {
	...
	if (((parentObject.XMLload==0)&&(this.XMLsource))&&(!this.XMLloadingWarning))
	{
		...
		this.loadXML(this.XMLsource+getUrlSymbol(this.XMLsource)+"itemId="+escape(parentObject.id));
	}
...
*/		
			...
			if ((this.XMLsource)&&(!itemObject.XMLload)) {
			itemObject.XMLload=1; this.loadXML(this.XMLsource+getUrlSymbol(this.XMLsource)+"id="+escape(itemObject.id)); return;
			};
...
dhtmlXTreeObject.prototype._createItem=function(acheck,itemObject,mode) {
	...
	itemObject.span.style.paddinRight="5px";
...
dhtmlXTreeObject.prototype.setOnRightClickHandler=function(func) {
	if (typeof(func)=="function") this.arFunc=func; else this.arFunc=eval(func);
};
...
dhtmlXTreeObject.prototype.setOnClickHandler=function(func) {
	if (typeof(func)=="function") this.aFunc=func; else this.aFunc=eval(func);
};
...
dhtmlXTreeObject.prototype.setOnCheckHandler=function(func) {
	if (typeof(func)=="function") this.checkFuncHandler=func; else this.checkFuncHandler=eval(func);
};
...
dhtmlXTreeObject.prototype.setOnOpenHandler=function(func) {
	if (typeof(func)=="function") this.openFuncHandler=func; else this.openFuncHandler=eval(func);
};
...
dhtmlXTreeObject.prototype._moveNodeTo=function(itemObject,targetObject,beforeNode) {
	...
	if ((targetObject.XMLload==0)&&(this.XMLsource))
	{
		...
		this.loadXML(this.XMLsource+getUrlSymbol(this.XMLsource)+"id="+escape(targetObject.id));
	}
...
dhtmlXTreeObject.prototype._checkParenNodes=function(itemId,htmlObject,shtmlObject) {
	if (shtmlObject) {
		if (shtmlObject.parentObject.id==htmlObject.id)  return 1;
	}
...
*     @topic: 0  
*/
dhtmlXTreeObject.prototype.enableCheckBoxes=function(mode) {
...
dhtmlXTreeObject.prototype._getAllChecked=function(htmlNode,list,mode) {
	...
	if (((mode)&&(htmlNode.checkstate==1))||((!mode)&&(htmlNode.checkstate>0)))
		if (!htmlNode.nocheckbox)  {
			if (list) list+=","+htmlNode.id; else list=htmlNode.id;
		}
...
dhtmlXTreeObject.prototype.setDragHandler=function(func) {
	if (typeof(func)=="function") this.dragFunc=func; else this.dragFunc=eval(func);
};
