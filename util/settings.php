...
function load_settings( &$conf ) {
    ...
    while ( $setting = mysql_fetch_array( $result ) ) {
        ...
        switch ( $key ) {
            ...
            case "welcome_email": $conf['welcome_email'] = $val;
                break;
            case "welcome_subject": $conf['welcome_subject'] = $val;
                break;

            case "nameservers_ns1": $conf['dns']['nameservers'][0] = $val;
                break;
            case "nameservers_ns2": $conf['dns']['nameservers'][1] = $val;
                break;
            case "nameservers_ns3": $conf['dns']['nameservers'][2] = $val;
                break;
            case "nameservers_ns4": $conf['dns']['nameservers'][3] = $val;
                break;

            case "invoice_text": $conf['invoice_text'] = $val;
                break;
            case "invoice_subject": $conf['invoice_subject'] = $val;
                break;
            ...
            case "locale_language":
                ...
                break;
            case "locale_currency_symbol": $conf['locale']['currency_symbol'] = $val;
                break;
            ...
            case "order_accept_checks": $conf['order']['accept_checks'] = $val;
                break;
            case "order_title": $conf['order']['title'] = $val;
                break;
            case "order_tos_required": $conf['order']['tos_required'] = $val;
                break;
            case "order_tos_url": $conf['order']['tos_url'] = $val;
                break;

            case "theme_manager": $conf['themes']['manager'] = $val;
                break;
            case "theme_order": $conf['themes']['order'] = $val;
                break;
        }
    }
}
